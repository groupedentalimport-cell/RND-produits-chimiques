...
async function seed() {
  ...
  // NEW: Create degradation products with percentage + hazardLevel
  ...
  // NEW: Create drug interactions (DB-driven instead of hardcoded)
  ...
  // NEW: Create notifications (DB-driven instead of SAMPLE_NOTIFICATIONS)
